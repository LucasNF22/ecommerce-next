...
export const Pagination = ({ totalPages }: Props) => {
    ...
    const createPageUrl = ( pageNumber: number | string ) => {
        ...
        if( +pageNumber <= 0 ){ // el + se usa para convertirlo a numero
            return `${ pathname }` // href= "/"
        }

        if( +pageNumber > totalPages ){ // apretando el next>
            return `${ pathname }?${ params.toString()}`
        }
        ...
        <div className="flex justify-center items-center mt-10 mb-32">
            <nav aria-label="Page navigation example">
                ...
                <ul className="flex list-style-none">
                    ...
                    <li className="page-item items-center flex">
                        <Link
                    ...
                    <li className="page-item active"><a
                        ...
                        href="#">2 <span className="visually-hidden"></span></a>
                    </li>
